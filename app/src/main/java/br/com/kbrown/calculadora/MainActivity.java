...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btnmais = (Button) findViewById(R.id.btn_soma);
        final Button btnmenos = (Button) findViewById(R.id.btn_subtracao);
        final Button btndivi = (Button) findViewById(R.id.btn_divisao);
        final Button btnmulti = (Button) findViewById(R.id.btn_multiplicacao);
        final Button btnponto = (Button) findViewById(R.id.btn_ponto);
        final Button btnclear = (Button) findViewById(R.id.btn_apagar);
